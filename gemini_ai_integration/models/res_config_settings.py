...
class ResConfigSettings(models.TransientModel):
    ...
    def _get_default_gemini_model(self):
        return self.env.ref('gemini_ai_integration.gemini-pro-vision').id

    gemini_api_key = fields.Char(
        string="Gemini API key",
        help="Provide Gemini API Key here",
        config_parameter="gemini_ai_integration.gemini_api_key"
    )
    ...
    gemini_model_id = fields.Many2one(
        ...
        config_parameter="gemini_ai_integration.gemini_model"
    )
